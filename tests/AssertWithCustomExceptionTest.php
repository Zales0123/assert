...
class AssertWithCustomExceptionTest extends TestCase
{
    ...
    public function testAssert($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        ...
        call_user_func_array(array(Assert::class, $method), array_merge($args, ['', CustomException::class]));
    ...
    public function testNullOr($method, $args, $success, $multibyte = false, $minVersion = null)
    {
        ...
        call_user_func_array(array('Webmozart\Assert\Assert', 'nullOr'.ucfirst($method)), $args + [CustomException::class]);
        $this->addToAssertionCount(1);
    }
